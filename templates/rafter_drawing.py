...
function draw() {
  ...
  svg.appendChild($t(d1X + d1W/2, d1NotesY + 16, '8 TEK SCREW HOLES (2 COL \u00D7 4 ROW)', 'note', 'middle'));
  svg.appendChild($t(d1X + d1W/2, d1NotesY + 24, 'RAFTER: RECT BOX SECTION', 'note', 'middle'));
