...
def generate_construction_quote_pdf(data: dict) -> bytes:
    ...
    hdr_data = [[
        Paragraph(
            ...
            '<font size="9" color="#666666">Construction Quote</font>',
            ParagraphStyle("h", fontName="Helvetica-Bold", fontSize=18, leading=22)
        ),
        Paragraph(
    ...
    story.append(Paragraph(
        ...
        f'This quote is valid for 30 days from the date above.',
